    ...
    return (
        <section className="pt-[150px] items-center px-10 text-white bg-[rgb(11_23_20)] flex flex-col gap-12 relative w-full">
            <div className="flex max-lg:flex-col max-lg:text-center">
                <div>
                    <h1 className="lg:text-[66px] md:text-5xl text-3xl space leading-tight font-semibold">
                        Taking care of pests so you can{" "}
                        <span className="text-primary">relax</span> and{" "}
                        <span className="text-primary">breathe</span> easy.
                    </h1>
                </div>
                <div className="lg:ml-10 max-lg:items-center lg:w-[490px] gap-4 text-[15px] font-semibold text-muted/70 flex flex-col ">
                    <p>
